<section>
    <header>
        <h2 class="text-lg font-medium text-gray-900">
            {{ __('Kepegawaian (Update)') }}
        </h2>

        <p class="mt-1 text-sm text-gray-600">
            {{ __("Perbarui data lokasi dan jabatan Anda di sini.") }}
        </p>
    </header>
    ...
    <form method="post" action="{{ route('profile.update-employment') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <select id="site_id" name="site_id" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" style="background-color: #ffffff !important; color: #000000 !important; opacity: 1 !important;">
        ...
        <div>
            ...
            <input id="position" name="position" type="text" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" style="background-color: #ffffff !important; color: #000000 !important; opacity: 1 !important;" value="{{ old('position', $user->position) }}">
        ...
        <div>
            ...
            <div class="mt-1 block w-full p-2.5 bg-gray-50 border border-gray-300 text-gray-500 text-sm rounded-lg">
