                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('products.store') }}" class="space-y-6 max-w-xl">
                        ...
                        <div>
                            ...
                            <x-prsystem::text-input id="code" class="block mt-1 w-full" type="text" name="code" :value="old('code')" required autofocus />
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <x-prsystem::text-input id="unit" class="block mt-1 w-full" type="text" name="unit" :value="old('unit')" required />
                            ...
                            <div>
                                ...
                                <x-prsystem::text-input id="price_estimation" class="block mt-1 w-full" type="number" name="price_estimation" :value="old('price_estimation', 0)" min="0" step="0.01" />
                        ...
                        <div>
                            ...
                            <x-prsystem::text-input id="min_stock" class="block mt-1 w-full" type="number" name="min_stock" :value="old('min_stock', 0)" min="0" />
                            <x-prsystem::input-error :messages="$errors->get('min_stock')" class="mt-2" />
                        </div>

                        <div class="flex items-center gap-4">
                            <x-prsystem::primary-button>{{ __('Save Product') }}</x-prsystem::primary-button>
