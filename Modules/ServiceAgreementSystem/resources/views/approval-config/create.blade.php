<x-serviceagreementsystem::layouts.master :title="'Tambah Konfigurasi Approval'">

<div class="card" style="max-width: 800px; margin: 0 auto;">
    <div class="card-header">
        <h2 class="card-title">Tambah Konfigurasi Approval</h2>
    </div>
    <div class="card-body">
        <form action="{{ route('sas.approval-configs.store') }}" method="POST">
            @csrf
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                <div class="form-group" style="margin-bottom: 20px;">
                    ...
                    <input type="number" name="level" id="level" class="form-control" value="{{ old('level', 1) }}" min="1" required style="width: 100%; padding: 10px 14px; border: 1px solid var(--border-color); border-radius: 8px; outline: none;">
                ...
                <div class="form-group" style="margin-bottom: 20px;">
                    ...
                    <input type="number" name="min_value" id="min_value" class="form-control" value="{{ old('min_value') }}" min="0" step="0.01" style="width: 100%; padding: 10px 14px; border: 1px solid var(--border-color); border-radius: 8px; outline: none;">
