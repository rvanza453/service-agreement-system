...
<body>
<div class="wrap">
    <h1 style="margin-top:0;">Edit Akun</h1>
    <p style="color:#64748b;">Perbarui data user dan ubah role per module kapan saja.</p>
    ...
    <form method="POST" action="{{ route('accounts.update', $user) }}" class="card">
        @method('PUT')
        @include('users._form')
    </form>
</div>
